  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved subject as @subject" do
        ...
        post :create, {:subject => { "subject" => "invalid value" }}, valid_session
        assigns(:subject).should be_a_new(Subject)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested subject" do
        ...
        Subject.any_instance.should_receive(:update_attributes).with({ "subject" => "MyString" })
        put :update, {:id => subject.to_param, :subject => { "subject" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the subject as @subject" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Subject.any_instance.stub(:save).and_return(false)
        put :update, {:id => subject.to_param, :subject => { "subject" => "invalid value" }}, valid_session
        assigns(:subject).should eq(subject)
      end
